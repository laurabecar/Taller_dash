...
def load_data():
    ...
    df = pd.read_csv(r'/Users/laurabecerracardona/Documents/Taller/datos_energia.csv')

    # Asumiendo que la primera columna contiene las fechas en formato "yyyy-mm-dd"
